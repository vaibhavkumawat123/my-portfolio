    ...
    <section id="skills" className="py-20 px-4 sm:px-6 lg:px-8 bg-black/20">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="flex flex-wrap justify-center items-center text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 text-center">
            <img
              className="h-[10vh] w-[7rem] sm:h-[12vh] sm:w-[8rem] md:h-[14vh] md:w-[9rem] object-contain"
              src={img}
              alt="Skill Icon"
            />
